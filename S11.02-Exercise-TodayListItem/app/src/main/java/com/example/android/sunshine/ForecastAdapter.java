...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        int resource;
        if(forecastAdapterViewHolder.getItemViewType() == TODAY_LAYOUT) {
            resource = SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(weatherId);
        } else {
            resource = SunshineWeatherUtils.getSmallArtResourceIdForWeatherCondition(weatherId);
        }

        forecastAdapterViewHolder.iconView.setImageResource(resource);
    ...
    public int getItemViewType(int position) {
        return (mUseTodayLayout && position == 0) ? TODAY_LAYOUT : FUTURE_LAYOUT;
    }
