...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        forecastAdapterViewHolder.weatherSummary.setText(getCurrentWeather());
    }

    private String getCurrentWeather(){
        return String.format(
                "date: %s, high: %s, low: %s",
                new Date(mCursor.getLong(mCursor.getColumnIndex(COLUMN_DATE))).toString(),
                mCursor.getFloat(mCursor.getColumnIndex(COLUMN_MAX_TEMP)),
                mCursor.getFloat(mCursor.getColumnIndex(COLUMN_MIN_TEMP))
        );
    }
