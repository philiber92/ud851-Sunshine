...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static int LOADER_WEATHER_QUERY = 22;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loaderManager.initLoader(LOADER_WEATHER_QUERY, null, this);
    ...
    private void loadWeatherData() {
        ...
        LoaderManager loaderManager = getSupportLoaderManager();
        loaderManager.restartLoader(LOADER_WEATHER_QUERY, bundle, this);
    }
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                if(location == null || location.isEmpty()) return new String[] {};
